...
There are two methods of running the MCP Server, Rover or Docker. Depending on which you prefer, follow those steps.
...
1. Modify the configuration YAML for the example code to the following:
    ```yaml graphql/TheSpaceDevs/config.yaml {7, 10}
