...
graph LR
    ...
    class AI aiClient primary
    class MCPClient mcpComponent primary
    class MCPServer apolloComponent primary
    class GraphQL apiComponent secondary
    class Data dataComponent tertiary
    class OpFiles,PQM,Introspection apolloComponent secondary
    class Tools mcpComponent secondary
```
