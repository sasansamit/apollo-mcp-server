...
If you have an existing GraphQL API deployed, we recommend using the stand-alone MCP server binary to get started quickly.

If you use Docker in your developer workflow, we recommend using the Apollo MCP Server Docker image.
