...
The Apollo MCP Server exports telemetry data with the OpenTelemetry Protocol to provide enhanced observability into its operations. It emits detailed traces and metrics, allowing operators to monitor the server's health, performance, and behavior in detail.
...
This integration provides visibility that is crucial for diagnosing errors, identifying performance bottlenecks, and understanding how different tools are being used.
