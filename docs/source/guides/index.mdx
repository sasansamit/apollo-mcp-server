...
To set up auth in the MCP server, you will need:
1. An [OAuth 2.1-compliant](https://oauth.net/2.1/) Identity Provider (for example, Auth0, Okta, Keycloak, are popular IdPs).
...
### Example auth configuration with Auth0

Here is an example of how to set up the MCP server with Auth0 as the Identity Provider.
